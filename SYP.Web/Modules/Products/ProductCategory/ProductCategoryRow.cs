...
[ConnectionKey("Default"), Module("Products"), TableName("ProductCategory")]
[DisplayName("Kategoriler"), InstanceName("Kategori")]
[NavigationPermission("Products:ProductCategory:Navigation")]
[ReadPermission("Products:ProductCategory:Read")]
[InsertPermission("Products:ProductCategory:Insert")]
[UpdatePermission("Products:ProductCategory:Update")]
[DeletePermission("Products:ProductCategory:Delete")]
[ServiceLookupPermission("Products:ProductCategory:Lookup")]
public sealed class ProductCategoryRow : Row<ProductCategoryRow.RowFields>, IIdRow, INameRow
{
    ...
    [DisplayName("Parent Name"), Origin(jParent, nameof(ProductCategoryRow.Name)), ReadOnly(true)]
