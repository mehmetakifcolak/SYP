import { Decorators, deepClone, DeleteResponse, SaveResponse, ServiceOptions, tryGetText, EntityDialog} from "@serenity-is/corelib"
import { GridEditorBase } from "./GridEditorBase"
import { DefaultEditorDialogOptions } from "../_q/_q";

@Decorators.panel(false)
export class EditorDialogBase<TEntity> extends EntityDialog<TEntity, any> {

    protected get_ExtDialogOptions(): ExtDialogOptions { return deepClone(DefaultEditorDialogOptions); }
