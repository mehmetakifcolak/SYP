import { CascadedWidgetLink, ComboboxEditorOptions, Decorators, EditorUtils, Fluent, getType, IGetEditValue, IReadOnly, isEmptyOrNull, ISetEditValue, IStringValue, IValidateRequired, resolveUrl, RetrieveColumnSelection, RetrieveRequest, RetrieveResponse, serviceCall, Widget, WidgetProps, EntityDialog} from "@serenity-is/corelib";
...
export class GridItemPickerEditor<P extends GridItemPickerEditorOptions = GridItemPickerEditorOptions>
    ...
    private getDialogInstance(): EntityDialog<any, any> {
        ...
        try {
            var dlg = new dialogType() as EntityDialog<any, any>;
            return dlg;
        } catch (ex) {
