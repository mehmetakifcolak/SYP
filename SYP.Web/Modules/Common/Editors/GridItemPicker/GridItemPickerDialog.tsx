import { BaseDialog, Decorators, getType, localText, notifyWarning, EntityGrid} from "@serenity-is/corelib";

@Decorators.registerClass()
export class GridItemPickerDialog<TItem> extends BaseDialog<GridItemPickerEditorOptions> {

    checkGrid: EntityGrid<TItem, GridItemPickerEditorOptions>;
