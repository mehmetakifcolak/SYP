...
namespace SYP.Common.DevTools
{
    public class SchemaHelper
    {
        ...
        {
            var providerType =
                Type.GetType("Serenity.Data.Schema." + serverType + "SchemaProvider, Serenity.Net.Services") ??
                Type.GetType("Serenity.Data.Schema." + serverType + "SchemaProvider, Serenity.Net.Data") ??
