...
namespace SYP.Common.DevTools.Pages
{
    using Serenity;
    using Serenity.Data;
    using System;
    ...
    public class GenerateMigrationFromEntityController : Controller
    {
        ...
        {
            return View("~/Modules/Common/DevTools/GenerateMigrationFromEntity/GenerateMigrationFromEntityIndex.cshtml");
        }
        ...
        public ActionResult MigrationViewer()
        {
            ...
            return View("~/Modules/Common/DevTools/GenerateMigrationFromEntity/GenerateMigrationFromEntityMigrationViewer.cshtml", model);
        }
        ...
        public ActionResult GenerateSingleFile()
        {
            ...
            return View("~/Modules/Common/DevTools/GenerateMigrationFromEntity/GenerateMigrationFromEntitySuccessMsg.cshtml", model);
        }
