import { EditorUtils, Fluent, Widget, EntityDialog} from "@serenity-is/corelib"
import { GridEditorBase } from "../Editors/GridEditorBase"

export function initDetailEditor(dialog: EntityDialog<any, any>, editor: GridEditorBase<any>, options: ExtGridEditorOptions = {}): void {
