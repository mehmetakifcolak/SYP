...
public sealed class ProductsRow : Row<ProductsRow.RowFields>, IIdRow, INameRow, SYP.Administration.IAuditedRow
{
    ...
    [DisplayName("Brand"), LookupInclude, ForeignKey(typeof(BrandsRow)), LeftJoin(jBrand)]
    ...
    [DisplayName("Unit"), LookupInclude, ForeignKey(typeof(Setting.UnitsRow)), LeftJoin(jUnit)]
    ...
    [DisplayName("Category Name"), Expression($"{jCategory}.[Name]"), LookupInclude]
    ...
    [DisplayName("Unit Name"), Expression($"{jUnit}.[Name]"), LookupInclude]
