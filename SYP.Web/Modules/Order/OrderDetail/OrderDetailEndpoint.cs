...
[Route("Services/Order/OrderDetail/[action]")]
...
public class OrderDetailEndpoint : ServiceEndpoint
{
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(Columns.OrderDetailColumns), request.ExportColumns);
        return ExcelContentResult.Create(bytes, "OrderDetailList_" +
