...
export namespace ProductCategoryService {
    export const baseUrl = 'Products/ProductCategory';
    ...
    export const Methods = {
        Create: "Products/ProductCategory/Create",
        Update: "Products/ProductCategory/Update",
        Delete: "Products/ProductCategory/Delete",
        Retrieve: "Products/ProductCategory/Retrieve",
        List: "Products/ProductCategory/List"
    } as const;
