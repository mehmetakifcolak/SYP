...
export interface CurrencyListForm {
    Code: StringEditor;
    Name: StringEditor;
...
export class CurrencyListForm extends PrefixedContext {
    static readonly formKey = 'Setting.CurrencyList';
    private static init: boolean;

    constructor(prefix: string) {
        super(prefix);

        if (!CurrencyListForm.init) {
            CurrencyListForm.init = true;
